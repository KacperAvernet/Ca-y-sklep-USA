...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  'ShopThemeCheckout' => 
  array (
    'I agree to the [terms of service] and will adhere to them unconditionally.' => 'I agree to the [terms of service]',
    'A minimum shopping cart total of %amount% (tax excl.) is required to validate your order. Current cart total is %total% (tax excl.).' => 'A minimum shopping cart total of %amount% (tax excl.).',
    'I would like my order to be gift wrapped %cost%' => 'I would like my order delivered in a cooler bag with ice packs. %cost%',
    'Gift wrapping' => 'Cooler with ice packs',
  ...
  array (
    'You do not have any vouchers.' => 'You do not have any coupons.',
  ...
  'ShopThemeGlobal' => 
  array (
    'Get our latest news and special sales' => 'Sign up to get $20 off your first order, latest news and special sales.',
    'Undefined' => 'Undefined',
    'Home' => 'Home',
    'Addresses' => 'Addresses',
