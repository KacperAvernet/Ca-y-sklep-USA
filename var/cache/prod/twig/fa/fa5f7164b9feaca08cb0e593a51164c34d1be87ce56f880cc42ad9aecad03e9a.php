...
class __TwigTemplate_7c777972db3c74d76bf4c3dc38ae180ae3f5b8b8c1e6c93c93fbeea99a8ce552 extends Twig_Template
{
...
";
    ...
    public function block_maintenance_form_general($context, array $blocks = array())
    {
        ...
        echo "
                                ";
        // line 46
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "enable_shop", array()), 'errors');
        echo "
                                ";
        // line 47
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "enable_shop", array()), 'widget');
        echo "
                            </div>
                            <div class=\"form-group\">
                                ";
        ...
        echo "
                                ";
        // line 51
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_ip", array()), 'errors');
        echo "
                                ";
        // line 52
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_ip", array()), 'widget', array("currentIp" => (isset($context["currentIp"]) ? $context["currentIp"] : null)));
        echo "
                            </div>
                            <div class=\"form-group\">
                                ";
        ...
        echo "
                                ";
        // line 56
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_text", array()), 'errors');
        echo "
                                ";
        // line 57
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute((isset($context["generalForm"]) ? $context["generalForm"] : null), "maintenance_text", array()), 'widget');
        echo "
                            </div>
                            ";
        // line 59
...
";
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Configure/ShopParameters/maintenance.html.twig", "/home/www/clients/client1/web339/web/src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters/maintenance.html.twig");
    }
}
