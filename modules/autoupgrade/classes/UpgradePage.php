...
class UpgradePage
{
    ...
    private function _getJsErrorMsgs()
    {
        ...
        $ret = array(
            ...
            37 => $translator->trans('Impossible to write the image /img/logo.jpg. If this image already exists, please delete it.', array(), $translationDomain),
            38 => $translator->trans('The uploaded file exceeds the upload_max_filesize directive in php.ini', array(), $translationDomain),
            39 => $translator->trans('The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form', array(), $translationDomain),
            40 => $translator->trans('The uploaded file was only partially uploaded', array(), $translationDomain),
            41 => $translator->trans('No file was uploaded.', array(), $translationDomain),
            42 => $translator->trans('Missing a temporary folder', array(), $translationDomain),
            43 => $translator->trans('Failed to write file to disk', array(), $translationDomain),
            44 => $translator->trans('File upload stopped by extension', array(), $translationDomain),
            45 => $translator->trans('Cannot convert your database\'s data to utf-8.', array(), $translationDomain),
            47 => $translator->trans('Your firstname contains some invalid characters', array(), 'Install'),
            46 => $translator->trans('Invalid shop name', array(), 'Install'),
            49 => $translator->trans('Your database server does not support the utf-8 charset.', array(), 'Install'),
            50 => $translator->trans('Your MySQL server does not support this engine, please use another one like MyISAM', array(), $translationDomain),
            48 => $translator->trans('Your lastname contains some invalid characters', array(), $translationDomain),
            51 => $translator->trans('The file /img/logo.jpg is not writable, please CHMOD 755 this file or CHMOD 777', array(), $translationDomain),
            52 => $translator->trans('Invalid catalog mode', array(), $translationDomain),
